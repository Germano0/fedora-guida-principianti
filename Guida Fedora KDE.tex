...
interfaccia grafica con il quale si può interagire cliccando con il mouse. Essi sono chiamati
programmi con \texttt{interfaccia grafica}.
In un sistema operativo basato su kernel Linux, oltre a programmi del genere sopracitato,
sono presenti programmi con \texttt{interfaccia a riga di comando}. Per rendere l'idea, sono programmi 
come nell'immagine
AGGIUNGERE FIGURA
...
\section{La gestione degli utenti e dei permessi dei file}
